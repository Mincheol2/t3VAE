...
parser.add_argument('--test_N',         type=int,   default=5000000,help="Number of sample size of train data")
...
parser.add_argument('--gen_N',          type=int,   default=5000000,help="Number of generations")
